        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-[#22D3EE] via-[#6366F1] to-[#F472B6] px-7 py-3 text-sm font-semibold text-[#0b0a12] shadow-[0_20px_60px_rgba(34,211,238,0.25)] transition hover:shadow-[0_20px_80px_rgba(34,211,238,0.35)]"
              >
                Begin the conversation
              </a>
              <a
                href="#work"
                className="inline-flex items-center justify-center rounded-full border border-white/15 bg-white/5 px-7 py-3 text-sm font-semibold text-slate-100 backdrop-blur transition duration-300 hover:bg-white/10"
              >
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch">
            ...
            >
              <div className="absolute inset-x-4 top-6 h-56 rounded-[2rem] bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.22),_transparent_35%),radial-gradient(circle_at_80%_50%,_rgba(244,114,182,0.16),_transparent_40%)]" />
              <div className="absolute inset-0 dot-pattern-subtle rounded-[2rem]" />
            ...
            >
              ...
              <div className="relative z-10 grid gap-6">
                ...
                <div className="relative isolate overflow-hidden rounded-[2rem] border border-white/10 bg-[#0c0c11]/80 p-6">
                  ...
                  <div className="absolute inset-0 line-pattern-vertical opacity-40" />
                  <div className="relative z-10 grid gap-4">
                    ...
                    <div className="relative rounded-[1.75rem] border border-white/10 bg-[#10101a]/90 p-6">
                      <div className="absolute inset-0 rounded-[1.75rem] bg-[radial-gradient(circle_at_top_left,_rgba(34,211,238,0.18),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(244,114,182,0.12),_transparent_32%)]" />
                      <div className="relative z-10 grid gap-4">
      ...
      <section id="logos" className="relative py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#11121b]/75 px-4 py-8 sm:px-6 sm:py-10">
            ...
            <div className="absolute inset-0 dot-pattern-accent opacity-30" />
              ...
              <div className="overflow-hidden rounded-[1.75rem] bg-[#0c0c11]/90 px-3 py-6 shadow-[inset_0_0_1px_rgba(255,255,255,0.04)] sm:px-5">
                <div className="flex min-w-[1200px] gap-8 animate-marquee will-change-transform">
                  {brandLogos.map((brand) => (
                    <div key={brand.name} className="flex h-16 w-48 items-center justify-center rounded-3xl bg-white/5 p-3 grayscale transition duration-500 group-hover:grayscale-0 hover:scale-[1.05]">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                {services.map((service, index) => (
                  <motion.div
                    ...
                    className="group relative rounded-[2rem] border border-white/10 bg-[#121217]/80 p-6 backdrop-blur-xl overflow-hidden"
                  >
                    <div className="absolute inset-0 dot-pattern-subtle opacity-40" />
            ...
            >
              ...
              <div className="absolute inset-0 line-pattern-vertical opacity-30" />
              <div className="relative z-10 grid gap-6">
      ...
      <section className="relative py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            >
              <div className="absolute inset-0 rounded-[2rem] bg-[radial-gradient(circle_at_20%_20%,_rgba(34,211,238,0.14),_transparent_25%),radial-gradient(circle_at_80%_10%,_rgba(244,114,182,0.12),_transparent_28%)]" />
              <div className="absolute inset-0 dot-pattern-subtle rounded-[2rem]" />
              <div className="relative z-10 grid gap-6">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {processItems.map((step, index) => (
                  <motion.div
                    ...
                    className="group relative rounded-[1.8rem] border border-white/10 bg-[#0d0d10]/85 p-6 text-center overflow-hidden"
                  >
                    <div className="absolute inset-0 dot-pattern-subtle opacity-30" />
                    <div className="relative z-10">
                      <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-3xl bg-gradient-to-br from-[#22D3EE]/20 via-[#6366F1]/15 to-[#F472B6]/20 text-lg font-semibold text-slate-300">
                        {index + 1}
                      </div>
                      <h3 className="text-xl font-semibold text-white">{step}</h3>
                      <p className="mt-3 text-sm leading-7 text-slate-400">{step === 'Discover' ? 'Map opportunity, users, and technical surface.' : step === 'Design' ? 'Craft product systems and agentic flows.' : step === 'Build' ? 'Ship production-ready AI systems.' : 'Launch globally with confidence.'}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
      ...
      <section id="contact" className="relative py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            transition={{ duration: 0.9, ease: 'easeOut' }}
            className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-[#0b0b10]/80 via-[#121216]/80 to-[#11121b]/80 p-8 shadow-[0_40px_120px_rgba(0,0,0,0.35)] backdrop-blur-xl"
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.18),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(244,114,182,0.14),_transparent_32%)]" />
            <div className="absolute inset-0 dot-pattern-subtle opacity-40" />
            <div className="relative z-10 grid gap-8 xl:grid-cols-[1.2fr_0.8fr] xl:items-center">
              ...
              <div className="space-y-4 rounded-[1.8rem] border border-white/10 bg-[#0c0c12]/90 p-8 shadow-[0_30px_80px_rgba(0,0,0,0.35)]">
                ...
                <a
                  ...
                  className="inline-flex w-full items-center justify-center rounded-full bg-gradient-to-r from-[#22D3EE] via-[#6366F1] to-[#F472B6] px-6 py-3 text-sm font-semibold text-[#0b0a12] shadow-[0_20px_60px_rgba(34,211,238,0.25)] transition hover:shadow-[0_20px_80px_rgba(34,211,238,0.35)]"
                >
                  Start a project
                </a>
              </div>
